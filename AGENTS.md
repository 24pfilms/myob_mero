...
- MyOb backend tests: from `MyOb/backend`, run `uv run python -m unittest test_attachment_migration.py test_codex_provider.py test_data_safety.py test_database_runtime.py test_local_embeddings.py test_migrations.py test_note_versions.py test_openai_provider.py test_route_order.py test_security.py test_semantic_endpoints.py test_tenant_isolation.py`
