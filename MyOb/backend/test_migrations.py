...
class MigrationTests(unittest.TestCase):
    def test_seeded_legacy_database_migrates_without_data_loss(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertEqual(apply_migrations(database_path, legacy_owner=owner), [2, 3, 4, 5])
            ...
            try:
                ...
                self.assertEqual(connection.execute("SELECT version, name FROM schema_migrations").fetchall(), [(1, "001_initial.sql"), (2, "002_tenant_ownership.sql"), (3, "003_local_embeddings.sql"), (4, "004_note_versions.sql"), (5, "005_attachments.sql")])
